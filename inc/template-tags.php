...
function minimalizr_posted_on() {
	...
	echo '<span class="posted-on hidden">' . esc_html(get_the_date()) . '</span><span class="byline"> '. esc_html(__('by', 'minimalizr')).' <span class="normal">'.get_the_author() . '</span></span>';
