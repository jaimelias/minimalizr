...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if (!empty($args->has_children)) $class_names .= ' dropdown';
        ...
        $item_output .= (!empty($args->has_children) && 0 === $depth) ? '<small class="caret inline-block text-muted pull-right">&#9660;</small></a>' : '</a>';
